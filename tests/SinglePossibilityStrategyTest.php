...
use AngeloMelonas\SudokuSolver\Strategies\SinglePossibility;
use PHPUnit\Framework\TestCase;

class SinglePossibilityStrategyTest extends TestCase
{
    /**
     * @test
     */
    ...
    private function assertStrategyOutput(array $strategyInput, array $strategyExpectedOutput)
    {
        ...
        $singlePossibilityStrategy = new SinglePossibility($M);
        $puzzlePostStrategy = $singlePossibilityStrategy->applyStrategy($strategyInput);
